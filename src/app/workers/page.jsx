    ...
    <div className="w-full mx-auto mt-[20px] flex flex-col ">
          ...
          <Card key={maid._id} className="relative shadow-lg py-4 md:p-4 scale-[90%] md:scale-100 bg-primary text-white hover:shadow-xl">
            <CardHeader>
              ...
              <CardTitle className="pt-[5%]">
                <h2 className="card-title  font-bold text-[14px] md:text-[20px] text-white">{maid.name}</h2>
              </CardTitle>
              <CardDescription>
                <span className=" text-[12px] first-line:md:text-[18px] text-white">Price:</span>
     ...
     <div className="flex flex-wrap items-center gap-4 justify-center pb-4">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <span className="ml-1 p-1 px-2 text-sm bg-secondary rounded-full text-white text-center">{`$${maid.pricePerMonth} per Month`}</span>
        <span className="ml-1 p-1 px-2 text-sm bg-secondary rounded-full text-white text-center">{`$${maid.pricePerHour} per Hour`}</span>
        </div>
      </div>   
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 pb-4">
         <span className="text-primary text-[18px]">Age:</span>
         <span className="text-secondary text-[17px]">{maid.age}</span>
      </div>
      <div className="flex flex-wrap items-center justify-center gap-2 pb-4">
         <span className="text-primary text-[18px]">Height:</span>
         <span className="text-secondary text-[17px]">{maid.height}</span>
      </div>
      <div className="flex flex-wrap items-center justify-center gap-2 pb-4">
         <span className="text-primary text-[18px]">Weight:</span>
         <span className="text-secondary text-[17px]">{maid.weight}</span>
      </div>
      </div>
      <div className="flex flex-wrap items-center justify-center gap-5">
      <div className="flex flex-wrap items-center justify-center gap-2 pb-4">
         <span className="text-primary text-[18px]">Phone Number:</span>
         <span className="text-secondary text-[17px]">{maid.phoneNumber}</span>
      </div>
      <div className="flex flex-wrap items-center justify-center gap-2 pb-4">
         <span className="text-primary text-[18px]">Address:</span>
         <span className="text-secondary text-[17px]">{maid.address}</span>
      </div>
      <div className="flex flex-wrap items-center justify-center gap-2 pb-4">
         <span className="text-primary text-[18px]">Educational Level:</span>
         <span className="text-secondary text-[17px]">{maid.educationalLevel}</span>
      </div>
      </div>
      ...
      <div className="flex items-center flex-col gap-4 w-[90%] md:w-1/2 rounded-2xl p-2 text-white bg-primary mx-auto mb-6">
             <span className=" text-[18px] flex items-center gap-2">  <NotebookText color="white"/>Skills:</span>
             <span className="ml-1">
        <div className="flex flex-col gap-1">
        {maid.skills.map((rev,index)=>(
